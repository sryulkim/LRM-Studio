        ...
        IVsCfgBrowseObject
    {
        ...
        public virtual int DebugLaunch(uint grfLaunch)
        {
            ...
            try
            {
                ...
                Trace.WriteLine("info.bstrExe:" + info.bstrExe);
                ...
                if(!string.IsNullOrEmpty(property))
                {
                    ...
                    Trace.WriteLine("info.bstrArg:" + info.bstrArg);
                }
                ...
                if(property != null && property.Length > 0)
                {
                    ...
                    Trace.WriteLine("info.bstrRemoteMachine:" + info.bstrRemoteMachine);
                }
                ...
                Trace.WriteLine("info.clsidCustom:" + info.clsidCustom);
