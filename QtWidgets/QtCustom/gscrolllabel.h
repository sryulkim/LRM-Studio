#ifndef GSCROLLLABEL_H
#define GSCROLLLABEL_H
...
{
    Q_OBJECT
    Q_CLASSINFO("ClassID", "{96BE9AA1-A1AF-452F-AD86-E7BA70ABC119}")
    Q_CLASSINFO("InterfaceID", "{022B5EEE-32C9-40B9-82AA-0CE333E329F3}")
    Q_CLASSINFO("EventsID", "{90C847F2-B378-4A41-B5A1-F2239604D90E}")
    Q_CLASSINFO("ToSuperClass", "GScrollLabel")
