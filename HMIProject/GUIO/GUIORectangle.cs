...
{
    public partial class GUIORectangle : UserControl
    {
        Pen pen;
        SolidBrush brush;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle(pen, pen.Width / 2, pen.Width / 2, this.Width - pen.Width, this.Height - pen.Width);
        }
    }
}
