// EmCL Studio.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "commctrl.h"
#include "ShellSection.h"
#include "EmCL Studio.h"
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	nRetVal = StartWithCommandLine(lpwCmdLine, L"EmCL_Studio", nCmdShow, NULL, NULL);
