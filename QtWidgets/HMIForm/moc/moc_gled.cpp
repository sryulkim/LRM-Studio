...
QT_MOC_LITERAL(1, 5, 12), // "checkChanged"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 3), // "val"
QT_MOC_LITERAL(4, 23, 10), // "setChecked"
QT_MOC_LITERAL(5, 34, 1) // "i"

    },
    "GLed\0checkChanged\0\0val\0setChecked\0i"
};
...
void GLed::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLed::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GLed::checkChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GLed::checkChanged(bool _t1)
{
