...
{
    public partial class HMIMakeConditionEventDialog : Form
    {
        public bool confirmFlag { get; set; }
        public HMIMakeConditionEventDialog()
        {
            InitializeComponent();
        ...
        private void HMIMakeConditionEventDialog_Load(object sender, EventArgs e)
        {
